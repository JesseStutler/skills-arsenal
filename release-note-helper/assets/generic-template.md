...
[1-2 paragraph overview of this release's focus and key highlights]

## What's New

[High-level highlights and key features from project planning or milestones]

- **[Key Feature 1]**: [Impact and short description] ([#PR_NUMBER](link), [@contributor])
- **[Key Feature 2]**: [Impact and short description] ([#PR_NUMBER](link), [@contributor])

## Other Notable Changes

### API Changes

- **[API Change]**: [What changed and why it matters] ([#PR_NUMBER](link), [@contributor])
...
- **API Changes**: Public or external interface changes
...
- **Contributors**: Always include, shows appreciation
